...
export const PawPrint: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M11 18.5c-2 0-4-1-4-3.5 0-2.4 2-4.5 4-4.5s4 2.1 4 4.5c0 2.5-2 3.5-4 3.5z" />
    <path d="M4.5 10.5c-1.5 0-2.5.5-2.5 2s1 2.5 2.5 2.5" />
    <path d="M17.5 10.5c1.5 0 2.5.5-2.5 2s-1 2.5-2.5 2.5" />
  </svg>
);
